    ...
    return (
      ...
      <div className="w3-container">
        ...
        <div className="w3-grey">
          <div className="w3-container w3-center w3-padding w3-green" >+25%</div>
        </div>
    
        <p>New Users</p>
        <div className="w3-grey">
          <div className="w3-container w3-center w3-padding w3-orange" >50%</div>
        </div>
    
        <p>Bounce Rate</p>
        <div className="w3-grey">
          <div className="w3-container w3-center w3-padding w3-red" >75%</div>
        </div>
      </div>
      <hr/>
